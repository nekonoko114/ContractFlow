<div class="w-full max-w-md">
    ...
    <div class="bg-white rounded-2xl border border-[#c7c4d8]/40 p-8 shadow-xl shadow-[#3525cd]/5">
        <div class="mb-6">
            <h2 class="text-xl font-bold text-[#131b2e]">アカウント新規登録</h2>
            <p class="text-xs text-[#505f76] mt-1">無料ですぐに回線管理を始められます</p>
        </div>

        <form wire:submit="register" class="space-y-4">
            <!-- Name Input -->
            <div class="space-y-1.5">
                <label class="block text-xs font-semibold text-[#464555]" for="name">お名前</label>
                <div class="relative">
                    ...
                    <input wire:model="name" 
                           ...
                           required 
                           placeholder="山田 太郎"
                           class="block w-full pl-10 pr-3.5 py-2.5 border border-[#c7c4d8]/70 rounded-xl bg-[#faf8ff]/50 text-[#131b2e] text-sm focus:outline-none focus:ring-2 focus:ring-[#3525cd]/20 focus:border-[#3525cd] transition-all duration-200 @error('name') border-red-500 @enderror">
                </div>
                @error('name')
            ...
            <!-- Password Input -->
            <div class="space-y-1.5">
                <label class="block text-xs font-semibold text-[#464555]" for="password">パスワード（8文字以上）</label>
                <div class="relative">
                    <span class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-[#777587]">
            ...
            <div class="space-y-1.5">
                <label class="block text-xs font-semibold text-[#464555]" for="password_confirmation">パスワード（確認用）</label>
                <div class="relative">
                    <span class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-[#777587]">
                    ...
                    <input wire:model="password_confirmation" 
                           ...
                           required 
                           placeholder="••••••••"
                           class="block w-full pl-10 pr-3.5 py-2.5 border border-[#c7c4d8]/70 rounded-xl bg-[#faf8ff]/50 text-[#131b2e] text-sm focus:outline-none focus:ring-2 focus:ring-[#3525cd]/20 focus:border-[#3525cd] transition-all duration-200">
                </div>
            </div>
            ...
            <div class="pt-2">
                <button type="submit" 
                    ...
                    <span wire:loading.remove wire:target="register">アカウントを登録する</span>
    ...
    <div class="mt-6 text-center">
        <p class="text-xs text-[#505f76]">
            すでにアカウントをお持ちですか？ 
            <a href="{{ route('login') }}" class="font-semibold text-[#3525cd] hover:underline">ログインはこちら</a>
        </p>
    </div>
</div>
